...
<body>
    <div class="container">
        ...
        <div class="footer-info">
            ...
            <div><i class="fas fa-clock"></i> Auto-refresh every 3 seconds • <i class="fas fa-raspberry-pi"></i> Raspberry Pi 5 Active Cooler</div>
        </div>
    </div>
        ...
        function updateDashboard() {
            fetch('/api/stats')
                ...
                .then(data => {
                    ...
                    fanCard.className = 'metric-card metric-normal';
